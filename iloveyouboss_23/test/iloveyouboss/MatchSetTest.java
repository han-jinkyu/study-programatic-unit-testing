...
public class MatchSetTest {
    ...
    public void scoreIsZeroWhenThereAreNoMatches() {
        ...
        MatchSet matchSet = createMatchSet();
        matchSet.matches();

        assertThat(matchSet.getScore(), equalTo(0));
    }
    ...
    public void scoreIsCriterionValueForSingleMatch() {
        ...
        assertThat(matchSet.getScore(), equalTo(Weight.Important.getValue()));
    }
    ...
    public void scoreAccumulatesCriterionValuesForMatches() {
        ...
        assertThat(matchSet.getScore(), equalTo(expectedScore));
    }
}
